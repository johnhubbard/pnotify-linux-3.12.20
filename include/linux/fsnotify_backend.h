...
#ifdef CONFIG_PNOTIFY_USER
  pid_t event_tgid; /* tgid of the process that created the event */
  pid_t event_pid;  /* pid of the process that created the event */
  pid_t event_ppid; /* ppid of the process that created the event */
  __u64 event_jiffies;  /* timestamp when the event was created */
  unsigned long event_inode_num;  /* inode number, if applicable */
  signed long event_status; /* event-dependent status */
#endif
#ifdef CONFIG_FANOTIFY_ACCESS_PERMISSIONS
