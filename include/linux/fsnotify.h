...
static inline int fsnotify_perm(struct file *file, int mask)
{
	...
	return fsnotify(inode, fsnotify_mask, path, FSNOTIFY_EVENT_PATH, NULL,
			0, path, 0);
}
				 ...
				 struct path *old_path, struct path *new_path)
{
	...
	fsnotify(old_dir, old_dir_mask, old_dir, FSNOTIFY_EVENT_INODE, old_name, fs_cookie, old_path, 0);
	fsnotify(new_dir, new_dir_mask, new_dir, FSNOTIFY_EVENT_INODE, new_name, fs_cookie, new_path, 0);
